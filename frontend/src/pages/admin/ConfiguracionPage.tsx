...
export const ConfiguracionPage = () => {
  ...
  return (
    ...
    >
      {/* Toast de éxito */}
      {successMsg && (
        <div className="bg-success-50/80 border border-success-100/70 text-success-700 px-5 py-4 rounded-2xl flex items-center gap-3 animate-fadeIn backdrop-blur-sm">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* ESTADO DEL LOCAL */}
          <div className="glass-panel rounded-2xl p-6 flex flex-col gap-5 justify-between relative overflow-hidden">
            ...
            <div className="space-y-4 pt-2">
              <div className="grid grid-cols-2 gap-3 bg-white/30 p-2 rounded-xl border border-white/40 backdrop-blur-sm">
                <button
                  type="button"
                  onClick={() => setLocalStatus('abierto')}
                  className={`py-2.5 rounded-xl text-sm font-bold transition-all cursor-pointer ${
                    localStatus === 'abierto'
                      ? 'glass-panel text-ink-900 shadow-sm'
              ...
              {localStatus === 'cerrado' && (
                <div className="bg-brand-yellow-50/70 border border-brand-yellow-200/60 rounded-xl p-3 flex gap-2 text-brand-yellow-800 text-xs leading-relaxed font-bold animate-fadeIn backdrop-blur-sm">
            ...
            <div className="border-t border-white/40 pt-4 flex justify-between items-center shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-5 py-2.5 bg-brand-red-500 hover:bg-brand-red-600 text-white font-bold text-sm rounded-2xl shadow-brand active:scale-[0.98] transition-all cursor-pointer disabled:opacity-40"
              >
                <Save size={16} />
          ...
          <form
            ...
            className="glass-panel rounded-2xl p-6 flex flex-col gap-5 justify-between relative overflow-hidden"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="glass-input pl-8 font-bold tabular-nums"
                />
              </div>
            </div>
